...
export default function WalletView() {
  ...
  const walletAddress = 'zpk_1234567890abcdef'; // Example address
  ...
  return (
    <div className="bg-white/10 backdrop-blur-md rounded-xl p-6 border border-white/20">
      ...
      <div className="mt-6">
        ...
        {activeTab === 'qr' && <QRContent walletAddress={walletAddress} />}
      </div>
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4 z-50">
          <div className="bg-gradient-to-br from-gray-900 to-gray-800 rounded-xl p-8 max-w-md w-full border border-white/10">
            ...
            <form className="space-y-4">
              ...
              <button
                type="submit"
                className="w-full bg-gradient-to-r from-blue-500 to-purple-500 text-white py-2 px-4 rounded-lg hover:from-blue-600 hover:to-purple-600 transition-all flex items-center justify-center space-x-2"
              >
                <span>Пошаљи</span>
...
function WalletContent({ onSend, onReceive }: { onSend: () => void; onReceive: () => void }) {
  return (
    <div className="space-y-6">
      <div className="text-center">
        <h2 className="text-3xl font-bold text-white mb-2">1,234.56 ЗПЛ</h2>
